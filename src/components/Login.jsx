        ...
        <div className="grid grid-cols-3 gap-3">
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map(d => (
            <button key={d} onClick={() => handleDigit(String(d))}
              className="h-16 rounded-2xl bg-[#080808] border border-zinc-800 text-white text-2xl font-semibold hover:bg-zinc-800 active:scale-95 transition-all select-none">
              {d}
            </button>
          ))}
          <div />
          ...
          <button onClick={handleDelete}
            className="h-16 rounded-2xl bg-[#080808] border border-zinc-800 text-zinc-400 hover:bg-zinc-800 active:scale-95 transition-all flex items-center justify-center select-none">
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4 relative overflow-y-auto">
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="bg-[#080808] border border-zinc-800 rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                autoComplete="off"
                spellCheck={false}
                className="w-full bg-[#080808] border border-zinc-700 rounded-xl px-4 py-3 text-white text-sm placeholder-zinc-700 focus:outline-none focus:border-[#faff05] transition-colors"
              />
            </div>
