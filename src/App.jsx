...
export default function App() {
  ...
  return (
    <div className="fixed inset-0 flex flex-col" style={BG_STYLE}>
      ...
      <div className="flex-shrink-0 flex items-center justify-between px-4 py-3 sm:px-[72px] sm:h-[72px] sm:py-0">
        ...
        {user && (
          <button onClick={handleLogout}
            className="text-zinc-600 hover:text-red-400 text-sm transition-colors flex items-center gap-1.5 sm:-mt-[3px]">
