...
function TaskCard({ task }) {
  ...
  return (
    <div className={`bg-[#111] border rounded-2xl p-5 transition-all ${task.status === 'done' ? 'border-zinc-800/30 opacity-60' : 'border-zinc-800/70'}`}>
      ...
      <div className="max-w-2xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-3 gap-3 mb-10">
          {[
            ...
            <div key={s.label} className="bg-[#111] border border-zinc-800/50 rounded-2xl p-4 text-center">
