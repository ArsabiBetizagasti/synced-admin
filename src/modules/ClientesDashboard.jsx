...
function ClientCard({ client, onClick }) {
  ...
  return (
    <button onClick={onClick}
      className="bg-[#1a1a1a] border border-zinc-800/60 rounded-2xl overflow-hidden hover:border-zinc-600 hover:scale-[1.02] transition-all text-left group">
...
function MiniTooltip({ active, payload, label }) {
  ...
  return (
    <div className="bg-[#111] border border-zinc-800 rounded-xl px-3 py-2 text-xs shadow-xl">
...
function ClientTaskCard({ task, clientColor, onMove, onDelete }) {
  ...
  return (
    <div
      ...
      className="bg-[#111] border border-zinc-800/80 rounded-xl p-3.5 cursor-grab active:cursor-grabbing hover:border-zinc-700 transition-all group"
  ...
  if (client.contractFile?.dataUrl) {
    return (
      <div className="mt-3 pt-3 border-t border-zinc-800/40">
        ...
        <div className="flex items-center gap-2 bg-[#111] rounded-xl px-3 py-2.5">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl overflow-hidden border border-zinc-800/60">
        ...
        <div className="bg-[#1a1a1a] px-6 py-5 flex items-center gap-5">
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          <div key={k.label} className="bg-[#1a1a1a] border border-zinc-800/50 rounded-2xl p-4">
            <div className="flex items-center justify-between mb-2">
      ...
      <div className="grid grid-cols-5 gap-4">
        {/* Income chart */}
        <div className="col-span-3 bg-[#1a1a1a] border border-zinc-800/50 rounded-2xl p-5">
        ...
        <div className="col-span-2 bg-[#1a1a1a] border border-zinc-800/50 rounded-2xl p-5 flex flex-col">
      ...
      <div>
        ...
        <button onClick={openDocumentos}
          className="w-full bg-[#1a1a1a] border border-zinc-800/50 rounded-2xl p-5 flex items-center justify-between hover:border-zinc-600 transition-all group text-left">
      ...
      {clientFinances.length > 0 && (
        <div>
          ...
          <div className="bg-[#1a1a1a] border border-zinc-800/50 rounded-2xl p-4 space-y-1.5 max-h-72 overflow-y-auto">
            {[...clientFinances].sort((a, b) => b.date.localeCompare(a.date)).map(entry => (
              <div key={entry.id} className="flex items-center gap-3 bg-[#111] rounded-xl px-3 py-2.5">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {projectClientNames.map(name => {
              ...
              return (
                <div key={name} className="bg-[#1a1a1a] border border-zinc-800/60 rounded-2xl overflow-hidden">
