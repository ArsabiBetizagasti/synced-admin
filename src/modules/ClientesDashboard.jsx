...
function ClientCard({ client, onClick }) {
  ...
  return (
    <button onClick={onClick}
      className="bg-[#0a0a0a] border border-zinc-800/60 rounded-2xl overflow-hidden hover:border-zinc-600 hover:scale-[1.02] transition-all text-left group">
...
function MiniTooltip({ active, payload, label }) {
  ...
  return (
    <div className="bg-[#0a0a0a] border border-zinc-800 rounded-xl px-3 py-2 text-xs shadow-xl">
...
function ClientTaskCard({ task, clientColor, onMove, onDelete }) {
  ...
  return (
    <div
      ...
      className="bg-[#0a0a0a] border border-zinc-800/80 rounded-xl p-3.5 cursor-grab active:cursor-grabbing hover:border-zinc-700 transition-all group"
  ...
  if (client.contractFile?.dataUrl) {
    return (
      <div className="mt-3 pt-3 border-t border-zinc-800/40">
        ...
        <div className="flex items-center gap-2 bg-[#0a0a0a] rounded-xl px-3 py-2.5">
  ...
  return (
    <div className="mt-3 pt-3 border-t border-zinc-800/40">
      <input ref={fileRef} type="file" className="hidden" accept=".pdf,.doc,.docx,.png,.jpg"
        onChange={handleFile} />
      <button onClick={() => fileRef.current?.click()}
        className="w-full flex items-center justify-center gap-2 py-2 rounded-xl border border-dashed border-zinc-700 text-zinc-500 hover:text-zinc-300 hover:border-zinc-500 transition-all text-xs">
        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl overflow-hidden border border-zinc-800/60">
        ...
        <div className="bg-[#0a0a0a] px-6 py-5 flex items-center gap-5">
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          <div key={k.label} className="bg-[#0a0a0a] border border-zinc-800/50 rounded-2xl p-4">
            <div className="flex items-center justify-between mb-2">
      ...
      <div className="grid grid-cols-5 gap-4">
        {/* Income chart */}
        <div className="col-span-3 bg-[#0a0a0a] border border-zinc-800/50 rounded-2xl p-5">
        ...
        <div className="col-span-2 bg-[#0a0a0a] border border-zinc-800/50 rounded-2xl p-5 flex flex-col">
      ...
      <div>
        ...
        <button onClick={openDocumentos}
          className="w-full bg-[#0a0a0a] border border-zinc-800/50 rounded-2xl p-5 flex items-center justify-between hover:border-zinc-600 transition-all group text-left">
            ...
            return (
              <div key={colId}
                ...
                <div className="space-y-2">
                  {colTasks.length === 0
                    ? <div className="text-center py-6 text-zinc-700 text-xs border-2 border-dashed border-zinc-800/60 rounded-xl">Sin tareas</div>
                    : colTasks.map(t => (
        ...
        <div>
          ...
          <div className="bg-[#0a0a0a] border border-zinc-800/50 rounded-2xl overflow-hidden">
            {clientProjects.map(p => {
              ...
              return (
                <div key={p.id} className="flex items-center gap-4 px-4 py-3 border-b border-zinc-800/40 last:border-0">
      ...
      {clientFinances.length > 0 && (
        <div>
          ...
          <div className="bg-[#0a0a0a] border border-zinc-800/50 rounded-2xl p-4 space-y-1.5 max-h-72 overflow-y-auto">
            {[...clientFinances].sort((a, b) => b.date.localeCompare(a.date)).map(entry => (
              <div key={entry.id} className="flex items-center gap-3 bg-[#0a0a0a] rounded-xl px-3 py-2.5">
      ...
      {history.length > 0 && (
        <div>
          ...
          <div className="bg-[#0a0a0a] border border-zinc-800/50 rounded-2xl overflow-hidden">
            <div className={`grid gap-2 text-[10px] text-zinc-500 uppercase tracking-wider px-5 py-3 border-b border-zinc-800 ${client.hasCommissions ? 'grid-cols-5' : 'grid-cols-3'}`}>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {projectClientNames.map(name => {
              ...
              return (
                <div key={name} className="bg-[#0a0a0a] border border-zinc-800/60 rounded-2xl overflow-hidden">
