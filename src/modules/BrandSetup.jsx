...
export default function BrandSetup() {
  const { clients, brands, saveBrand, updateClient } = useApp();
      ...
      <div className="w-56 flex-shrink-0 border-r border-[#111] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto py-2">
          {activeClients.map(client => {
            const hasBrand = !!client.brandSlug && !!brands[client.brandSlug];
      ...
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
        {!selectedClientId ? (
          <div className="flex-1 flex items-center justify-center text-zinc-600 text-sm">
            Select a brand from the list to set up or edit.
          </div>
        ) : (
          <>
            {/* Header */}
